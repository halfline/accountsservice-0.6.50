...
void accounts_user_complete_get_password_expiration_policy (
    AccountsUser *object,
    GDBusMethodInvocation *invocation,
...
void accounts_user_call_get_password_expiration_policy (
    AccountsUser *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean accounts_user_call_get_password_expiration_policy_finish (
    AccountsUser *proxy,
...
gboolean accounts_user_call_get_password_expiration_policy_sync (
    AccountsUser *proxy,
    gint64 *out_expiration_time,
    gint64 *out_last_change_time,
    gint64 *out_min_days_between_changes,
