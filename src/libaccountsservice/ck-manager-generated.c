 ...
 * @proxy: A #ConsoleKitManagerProxy.
 * @out_seats: (out) (array zero-terminated=1): Return location for return parameter or %NULL to ignore.
 ...
 * @proxy: A #ConsoleKitManagerProxy.
 * @out_sessions: (out) (array zero-terminated=1): Return location for return parameter or %NULL to ignore.
