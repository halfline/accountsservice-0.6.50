...
struct _AccountsAccountsIface
{
  ...
  const gchar *const * (*get_automatic_login_users) (AccountsAccounts *object);

  const gchar * (*get_daemon_version) (AccountsAccounts *object);

  gboolean  (*get_has_multiple_users) (AccountsAccounts *object);

  gboolean  (*get_has_no_users) (AccountsAccounts *object);
...
gboolean accounts_accounts_get_has_no_users (AccountsAccounts *object);
void accounts_accounts_set_has_no_users (AccountsAccounts *object, gboolean value);

gboolean accounts_accounts_get_has_multiple_users (AccountsAccounts *object);
void accounts_accounts_set_has_multiple_users (AccountsAccounts *object, gboolean value);

const gchar *const *accounts_accounts_get_automatic_login_users (AccountsAccounts *object);
gchar **accounts_accounts_dup_automatic_login_users (AccountsAccounts *object);
void accounts_accounts_set_automatic_login_users (AccountsAccounts *object, const gchar *const *value);
